...
cmake -G "MinGW Makefiles" -D BOOST_ROOT=%BOOST_DIR% -D OGRE_LIB=%OGRE_DIR%/build/lib/libOgreMain.dll.a -D OGRE_SDK=%OGRE_DIR%/build -D OGRE_HOME=%OGRE_DIR% -D OIS_HOME=%OIS_DIR% -D OIS_LIB=%OIS_DIR%/lib/libOIS.dll.a -D CMAKE_C_COMPILER=%TDM%/bin/gcc.exe -D CMAKE_CXX_COMPILER=%TDM%/bin/g++.exe -D CMAKE_BUILD_TYPE="Release" ../
